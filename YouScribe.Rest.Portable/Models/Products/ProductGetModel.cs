...
namespace YouScribe.Rest.Models.Products
{
    ...
    public class ProductGetDocument
    {
        ...
        public IEnumerable<ProductGetDocumentFormat> Formats { get; set; }
    }
    ...
    public class ProductGetModel
    {
        ...
        public IEnumerable<ProductGetTag> Tags { get; set; }

        public IEnumerable<ProductGetThumbnailUrl> ThumbnailUrls { get; set; }

        public IEnumerable<ProductGetOfferModel> Offers { get; set; }
